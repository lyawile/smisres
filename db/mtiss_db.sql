...
INSERT INTO `student` (`id`, `candidateNumber`, `firstname`, `middlename`, `surname`, `dateRegistered`, `phoneNumber`, `gender`, `birthDate`, `picUrl`, `vision`, `standardSeven`, `year`, `medium`, `address`) VALUES
(774, NULL, 'yusuf', 'Hassan', 'Lyawile', '2018-02-15 20:14:19', '0625155222', 'male', '2018-02-15', 'YUSUF_HASSAN.JPG', 0, 'Hajira Primary School', 2024, 'Swahili', 'Dar es Salaam');
...
--
ALTER TABLE `student`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=775;
--
